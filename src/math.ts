...
// export function compute2Digit(num: number): number {
//   const computedValue = 9 - num;
//   return computedValue;
// }

// export function compute3Digit(
//   num: number
...
// export function compute6Digit(num: number) {
//   const splitNum = num.toString().split("");
//   const firstValue = 8 - +splitNum[2];
//   const secondValue = 9 - +splitNum[1];
//   const thirdValue = 10 - +splitNum[0];
